      ...
      steps {
        ...
        stage ('Deploy into test-server using Ansible') {
           steps {
             ...
             ansiblePlaybook credentialsId: 'sshkey', disableHostKeyChecking: true, installation: 'ansible', inventory: '/etc/ansible/hosts', playbook: 'finance-playbook.yml', vaultTmpPath: '' 
           }
               }
     }
}
